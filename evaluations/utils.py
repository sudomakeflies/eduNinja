...
#             format_latex_value = format_latex.text.strip().lower() == 'true' if format_latex is not None else False
...
#             print(f"utils QTI parser Question Text: {question_text}")
#             print(f"utils QTI parser Options: {options}")
#             #print(f"Correct Answer: {correct_answer}")
